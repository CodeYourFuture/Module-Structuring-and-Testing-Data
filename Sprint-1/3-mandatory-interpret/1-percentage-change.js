...
b) Run the code and identify the line where the error is coming from - why is this error occurring? How can you fix this problem?
    1.
      ...
      the error accure because of the missing comma between the first argument and the second argument 
...
e) Describe what the expression Number(carPrice.replaceAll(",","")) is doing - what is the purpose of this expression?
     ...
     the purpose of this exprssion to convert the value of carePrice to a numeric value so we can use in the
      mathimatical Operations without getting the error Not a number "NAN"
