...
// 5 function calls: Line 4 - Number(), replaceAll() | Line 5 - Number(), replaceAll() | Line 10 - log()
...
// carPrice.replaceAll(",","") - removes all commas in the car price, so it can be converted to a Number without errors.
