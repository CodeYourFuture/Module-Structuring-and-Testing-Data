...
//c.Math.floor(...)
//Math.floor rounds down the resulting floating-point number to the nearest whole number (integer).
//This means the result of Math.floor(Math.random() * (maximum - minimum + 1)) will be an integer between 0 and 99 .
