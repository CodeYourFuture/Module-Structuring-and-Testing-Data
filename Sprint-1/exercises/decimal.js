...
let wholeNumberPart = Math.floor(num); // Get the whole number part
let decimalPart = parseFloat((num - wholeNumberPart).toFixed(4)); // Get the decimal part with precision
