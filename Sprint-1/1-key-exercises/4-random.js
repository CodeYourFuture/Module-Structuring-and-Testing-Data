...
//a random number between 0-1 exclusive and then rounded down to the nearest integer after which the minimum is added. The values  of num produced ranges from 1-100