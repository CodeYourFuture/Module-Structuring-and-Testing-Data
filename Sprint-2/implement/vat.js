...
/* For example, if your business sells sports equipment for £50, you multiply £50 
by 1.2 for a total VAT inclusive price of £60.*/
...
function addedVAT(number) {
    let totalWithVAT = (number * 1.2);
return totalWithVAT;
}

console.log(addedVAT(50));