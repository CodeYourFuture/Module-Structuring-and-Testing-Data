...
//rank You need to write assertions for your function to check it works in different cases
// we're going to use this helper function to make our assertions easier to read
// if the actual output matches the target output, the test will pass    
function assertEquals(actualOutput, targetOutput) {         
  console.assert(                                         // assertion error if the inputs are not the same
...
const freeCards = getCardValue("10♥");
assertEquals(freeCards, 10)
// Handle Ace (A):
