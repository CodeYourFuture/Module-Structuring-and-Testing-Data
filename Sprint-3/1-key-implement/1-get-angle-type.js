...
const notNumber = getAngleType("ninty");
assertEquals(notNumber, "Invalid angle");

const lessThanZero = getAngleType(-6);
assertEquals(lessThanZero, "Invalid angle");

const greaterThan360 = getAngleType(570);
assertEquals(greaterThan360, "Invalid angle")

const zero = getAngleType(0);
assertEquals(zero, "Zero angle");