...
const obtuseAngles = [91, 120, 179];
// ====> write your test here, and then add a line to pass the test in the function above
obtuseAngles.forEach((angle) => {
  assertEquals(getAngleType(angle), "Obtuse angle");
});
...
// ====> write your test here, and then add a line to pass the test in the function above
const reflexAngles = [181, 270, 359];
...
assertEquals(zeroAngle, "Zero angle");
