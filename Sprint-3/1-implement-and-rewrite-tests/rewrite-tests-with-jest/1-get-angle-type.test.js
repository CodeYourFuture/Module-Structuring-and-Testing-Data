...
test ('should return "Obtuse angle" when (angle < 180)', () => {
  expect(getAngleType(91)).toEqual("Obtuse angle");
  expect(getAngleType(175)).toEqual("Obtuse angle");
...
test ('should return "Reflex angle" when (angle < 360)', () => {
...
test ('should return "Invalid angle" when (angle > 360)', () => {
  ...
  expect(getAngleType(3854)).toEqual("Invalid angle");
