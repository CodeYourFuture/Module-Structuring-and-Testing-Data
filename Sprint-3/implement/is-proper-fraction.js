...
// my test function to make this easier for me to read and follow
...
assertEquals(numeratorLessThanDenom, true);
...
assertEquals(numeratorGreaterThanDenom, false);
...
// if we are going to throw an error we need to catch it
// this is new syntax for us, so let's try it out
...
assertEquals(equalNumDenom, false);
